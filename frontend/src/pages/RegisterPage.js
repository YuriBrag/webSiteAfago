					...
					<form onSubmit={handleSubmit} className="space-y-4">
						<div>
							...
							<input
								...
								className="shadow-sm appearance-none border rounded w-full py-3 px-4 text-gray-700"
								required
							/>
						</div>
						<div>
						...
						<button
							type="submit"
							disabled={loading}
							className="w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded transition-colors mt-6"
						>

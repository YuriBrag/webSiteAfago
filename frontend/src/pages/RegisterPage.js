...
import backgroundImage1 from '../assets/background_lp.jpg'; // 1. Importe a imagem
...
function RegisterPage() {
  ...
  // 2. Envolva o conteúdo no layout com fundo de imagem
  return (
    <div
      ...
      <div className="relative z-10 w-full flex justify-center">
        <div className="w-full max-w-md bg-white p-8 md:p-10 rounded-lg shadow-xl">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" disabled={loading} className="w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded transition-colors">

// src/pages/ListarFormulariosPage.test.js
...
describe('ListarFormulariosPage', () => {
  ...
  test('exibe mensagem de "nenhum formulário" quando a API retorna uma lista vazia', async () => {
    ...
    const noFormsMessage = await screen.findByText(/nenhum formulário encontrado/i);
  ...
  test('renderiza a lista de formulários quando a API retorna dados', async () => {
    ...
    const firstFormTitle = await screen.findByRole('heading', { name: /resposta_2025-06-15.txt/i });

...
describe('FormsPage', () => {
  ...
  test('renderiza o título principal corretamente', () => {
    ...
    const headingElement = screen.getByRole('heading', { name: /formulários/i });
  ...
  test('renderiza o link para responder formulário', () => {
    ...
    const responderLink = screen.getByRole('link', { name: /responder formulário/i });
